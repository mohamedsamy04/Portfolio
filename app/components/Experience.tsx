  ...
  const experiences = [
    {
      ...
      responsibilities: [
        ...
        "Taught HTML, CSS, Sass, Bootstrap, JavaScript, and jQuery",
    ...
    },
    {
      ...
      responsibilities: [
        "Completed Frontend Development track",
        "Gained skills in HTML, CSS, JavaScript",
        "Collaborated on team web applications",
        "Developed projects with responsive design",
      ],
    },
    {
      ...
      responsibilities: [
        "Completed intensive Frontend Web Development course",
        "Developed web applications with responsive design",
        "Gained experience with JavaScript and third-party libraries",
        "Focused on modern UI/UX practices",
      ],
    },
  ]
