...
import { GitlabIcon as GitHub, Linkedin, Mail, Facebook, Instagram, ArrowDown, Download } from "lucide-react"
                ...
                {imageError && (
                  <div className="w-full h-full flex items-center justify-center bg-gray-200 dark:bg-gray-700">
                    <span className="text-gray-500 dark:text-gray-400 text-center px-4">
                      Unable to load image. Please check the image URL or your internet connection.
                    </span>
                  </div>
                )}
                <Image
